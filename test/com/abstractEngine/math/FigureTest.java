...
public class FigureTest {
    ...
    public void mainMethods() {
        ...
        try {
            ...
            vectors.add(new Vector(-4, 0));
            vectors.add(new Vector(0, -4));
            Figure _1 = new Figure(new Point(2, 2), vectors);
            ...
            boolean check = false;
            try {
                Figure _3 = new Figure(new Point(2, 2), vectors);
    ...
    public void intersectionTest() {
        ...
        try {
            ...
            Figure _1 = new Figure(new Point(2, 2), vectors_1);
            ...
            Figure _2 = new Figure(new Point(3, 4), vectors_2);
            assert (Figure.intersection(_1, _2));
            Figure _3 = new Figure(new Point(5, 8), vectors_2);
            assert (Figure.intersection(_1, _3));
            Figure _4 = new Figure(new Point(6, 8), vectors_2);
